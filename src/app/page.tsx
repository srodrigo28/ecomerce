...
export default async function Home() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-10 px-6 py-10 sm:px-10 lg:px-12">
      <section className="grid gap-6 rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-8 shadow-[var(--shadow)] backdrop-blur md:grid-cols-[1.2fr_0.8fr] md:p-10">
        ...
        <aside className="rounded-[1.75rem] border border-[rgba(245,158,11,0.3)] bg-[rgba(255,255,255,0.92)] p-6">
      ...
      <section className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <article className="rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-8 shadow-[var(--shadow)]">
          ...
          <div className="mt-6 overflow-hidden rounded-3xl border border-[var(--border)] bg-slate-950 text-slate-100">
            <div className="grid grid-cols-[1fr_1fr] gap-px bg-slate-800 text-sm">
      ...
      <section id="vitrine-demo" className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <article className="rounded-[2rem] border border-[var(--border)] bg-[var(--surface)] p-8 shadow-[var(--shadow)]">
            ...
            {stores.map((store) => (
              <article key={store.id} className="overflow-hidden rounded-[1.75rem] border border-[var(--border)] bg-white">
                <div className="grid gap-4 md:grid-cols-[220px_1fr]">
                  <div className="h-full min-h-48 bg-slate-100">
